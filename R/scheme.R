#' A custome ggplot2 theme for styles of figures that I like.
#'
#' @usage schemeR()
#' @param graph_type The type of graph for the theme
#' @param angle Angle for X-axis labels
#' @param base_size Pt. size for text
#' @param base_family Font type, I think.
#' @param base_line_size Size of lines, default is base_size/22
#' @param base_rect_size Size of rect, default is base_size/22
#' @return ggplot-theme
#' @import ggplot2
#' @export
  ...
  if (grepl("bar", graph_type)) {
    schuy_theme <- schuy_theme %+replace%
      theme(
        ...
        panel.grid.minor.y = element_line(color = "#808080"),
      )
  }
